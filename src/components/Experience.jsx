          ...
          {experience.map((exp, index) => (
            ...
            >
              <motion.div
                ...
                className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-xl shadow-slate-200/50 dark:shadow-none hover:shadow-2xl transition-all border border-slate-200 dark:border-white/5"
              >
