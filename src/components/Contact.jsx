          ...
          >
            ...
            <div className="space-y-4">
              <motion.div whileHover={{ x: 10 }} className="glass-effect rounded-2xl p-5 flex items-center gap-4">
                <div className="w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center text-sky-500 text-xl font-bold">
                  <FaEnvelope />
                </div>
                <div>
              ...
              <motion.div whileHover={{ x: 10 }} className="glass-effect rounded-2xl p-5 flex items-center gap-4">
                <div className="w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center text-sky-500 text-xl">
                  <FaMapMarkerAlt />
                </div>
                <div>
            ...
            <form ref={form} onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input
                  ...
                  className="w-full bg-slate-900/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-sky-600 transition-colors"
                  required
                />
                <input
                  name="from_email"
              ...
              <textarea
                ...
                rows="5"
                className="w-full bg-slate-900/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-sky-600 transition-colors resize-none"
                required
              ></textarea>
